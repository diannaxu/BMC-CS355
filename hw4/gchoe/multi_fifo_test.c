 ...
 * 
 * Description:
 * Test to ensure that multiple threads are scheduled in FIFO.
 ...
 * Thread 10 entered work(), working!
 * Success: FIFO works as expected with multiple threads!
 */
...
int main() {
    ...
    printf("Success: FIFO works as expected with multiple threads!\n");
    exit(EXIT_SUCCESS);
}