// Second required test, this program checks to make sure that Mem_Alloc
// correctly allocates 8 bytes of memory, and tests by writing to the
// returned pointer, and reading back the value
// Victor Nault
