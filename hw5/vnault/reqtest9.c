// Ninth required test, this program checks to make sure that Mem_Alloc
// correctly allocates an 8-byte-aligned amount of memory, then
...
#define BYTES_TO_REQUEST 133
#define BYTES_TO_ALLOC 24
#define FAILURE -1
