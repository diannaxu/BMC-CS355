// Tenth required test, this program checks to make sure that Mem_Alloc
// correctly allocates a non-8-byte-aligned amount of memory, then
// frees the space and prints the Mem_Dump() to confirm
// Victor Nault
...
#define BYTES_TO_REQUEST 91
#define BYTES_TO_ALLOC 10
#define FAILURE -1
#define VALUE_TO_WRITE 3
...
int main() {
    ...
    Mem_Dump();
    printf("The second Mem Dump should have an extra free chunk, of %d rounded up to be 8-byte-aligned\n", BYTES_TO_ALLOC);
    return 0;
}
